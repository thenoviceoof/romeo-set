...
known as parameterization modules, offer various ways to mutate the parameters used to draw the fractal.
...
We are using a $640 \times 480$ pixel display, and plan on storing 8 bits of breakaway information. As such, we fill  307.2 kilobytes, or about 75% of the available RAM.
